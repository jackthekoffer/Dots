...
static Key keys[] = {
	/* modifier                     key        function        argument */
        { MODKEY,                       XK_r,      spawn,          SHCMD ("lf") },
        { 0,                            XK_Pause,  spawn,          SHCMD ("mpc toggle") },
        { MODKEY,                       XK_Insert, spawn,          SHCMD ("mpc next") },
        { MODKEY,                       XK_Delete, spawn,          SHCMD ("mpc prev") },
	{ 0,                            XK_Print,  spawn,          SHCMD ("~/.config/scripts/screenshot.sh") },
        { MODKEY,                       XK_Print,  spawn,          SHCMD ("~/.config/scripts/record.sh") },
	{ MODKEY,                       XK_d,      spawn,          SHCMD ("dmenu_run") }, /* Allows for Xresource */
